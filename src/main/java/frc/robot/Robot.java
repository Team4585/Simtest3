...
public class Robot extends HuskyRobot {
  ...
  private Simtest3TeleopDecisionMaker m_TeleopDecider = new Simtest3TeleopDecisionMaker();
  private Simtest3AutonomousDecisionMaker m_AutoDecider = new Simtest3AutonomousDecisionMaker();

  private Simtest3Chassis m_TheChassis = new Simtest3Chassis();
