...
public class Simtest3Joystick extends HuskyJoystick{
  private static final int Simtest3_JOYSTICK_PORT = 0;
  ...
  public Simtest3Joystick(){
      super(Simtest3_JOYSTICK_PORT);
  }
